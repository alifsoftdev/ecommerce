...
MyCartTotalsModel cartTotalsModelFromJson(String str) => MyCartTotalsModel.fromJson(json.decode(str));

String cartTotalsModelToJson(MyCartTotalsModel data) => json.encode(data.toJson());

class MyCartTotalsModel {
  MyCartTotalsModel({
  ...
  factory MyCartTotalsModel.fromJson(Map<String, dynamic> json) => MyCartTotalsModel(
